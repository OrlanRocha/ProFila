    ...
    <div class="col-lg-6">
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                <h1 class="h4 mb-3"><?= $usuario ? 'Editar usuário' : 'Novo usuário' ?></h1>
                <form method="post" action="index.php?r=usuarios/save">
                    <input type="hidden" name="_token" value="<?= htmlspecialchars($token) ?>">
                    <input type="hidden" name="id" value="<?= (int) ($usuario['id'] ?? 0) ?>">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label" for="nome">Nome</label>
                            <input type="text" class="form-control" name="nome" id="nome" required value="<?= htmlspecialchars($usuario['nome'] ?? '') ?>">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="papel" id="papel">
                        ...
                        <?php if (!$usuario): ?>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="senha" id="senha" placeholder="Gerada automaticamente se vazio">
                            </div>
                        <?php endif; ?>
                        <div class="col-12">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <a class="btn btn-outline-secondary" href="index.php?r=usuarios/index">Voltar</a>
